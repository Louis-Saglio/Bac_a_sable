...
def create_getter(attribute_name, tab="    "):
    return "def get_{attribute_name}(self):\n{tab}return self.{attribute_name}".format(attribute_name=attribute_name, tab=tab)


def create_setter(attribute_name, tab="    "):
    return "def set_{attribute_name}(self, new_{attribute_name}):\n{tab}self.{attribute_name} = new_{attribute_name}".format(attribute_name=attribute_name, tab=tab)
